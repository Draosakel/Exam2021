...
type TemplateClient interface {
	...
	Get(ctx context.Context, in *GetMessage, opts ...grpc.CallOption) (*Result, error)
	// one message is sent and one is recieved
	Put(ctx context.Context, in *PutMessage, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *templateClient) Get(ctx context.Context, in *GetMessage, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *templateClient) Put(ctx context.Context, in *PutMessage, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
...
type TemplateServer interface {
	// one message is sent and one is recieved
	Get(context.Context, *GetMessage) (*Result, error)
	// one message is sent and one is recieved
	Put(context.Context, *PutMessage) (*Ack, error)
...
func (UnimplementedTemplateServer) Get(context.Context, *GetMessage) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedTemplateServer) Put(context.Context, *PutMessage) (*Ack, error) {
...
func _Template_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TemplateServer).Get(ctx, req.(*GetMessage))
	}
...
func _Template_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TemplateServer).Put(ctx, req.(*PutMessage))
	}
	return interceptor(ctx, in, info, handler)
}
